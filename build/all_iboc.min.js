...
!function(){var t="tiles";if(window.IB.sd[t])return console.error("Warning: "+t+" loaded twice."),void(window.IB.sd[t].bind&&window.IB.sd[t].bind());var e=function(t,e,i){var s=document.createElement(t);return e&&(s.className=e),i&&(s.innerHTML=i),s},i=function(t,e,i){var s=t.classList;s.contains(e)?(s.add(i),s.remove(e)):(s.add(e),s.remove(i))},s=function(t,s,a,n){this.active=!1,this.tileContainer=t,this.aEl=e("div","pw-tile"),this.aEl.dataset.target=n,this.starEl=e("p","pw-tile-star"),this.titleEl=e("p","pw-tile-title",a),this.aEl.append(this.starEl),this.aEl.append(this.titleEl),this.tileContainer.append(this.aEl);var r=this;this.handler=function(e){var a=e.currentTarget.dataset.target;r.active=!r.active;for(var n=s.querySelectorAll("li"),l=0,o=n.length;o>l;l++)n[l].classList.contains("pw-tiles-appear")&&i(n[l],"pw-tiles-appear","pw-tiles-disappear");for(var c=t.querySelectorAll(".pw-tile"),l=0,o=c.length;o>l;l++)c[l].classList.remove("pw-tile-active");if(r.active){var d=s.querySelector('h3[data-target="'+a+'"]'),p=d.parentNode;p.style.display="",p.classList.remove("pw-tiles-disappear"),p.classList.add("pw-tiles-appear"),r.aEl.classList.add("pw-tile-active")}},this.aEl.addEventListener("click",this.handler)};s.prototype.severity=function(t){"important"==t?(this.starEl.innerHTML='<i class="fas fa-star"></i>',this.aEl.classList.add("pw-title-important")):(this.starEl.innerHTML="",this.aEl.classList.remove("pw-tile-important"))},s.prototype.dispose=function(t){this.aEl.removeEventListener("click",this.handler)};var a=function(t){this.tileContainer=e("div","pw-tiles-panel"),t.parentNode.insertBefore(this.tileContainer,t),this._container=t,this._sectionElems=t.querySelectorAll("li > h3[data-target]"),this.sections={};for(var i=0,a=this._sectionElems.length;a>i;i++){var n=this._sectionElems[i];n.parentNode.style.display="none";var r=n.getAttribute("data-target");if(r){var l=n.innerHTML,o=new s(this.tileContainer,t,l,r);this.sections[r]=o}}};a.prototype.autoCollapse=function(){console.error("Autocollapse not implemented in tiles")},a.prototype.severity=function(t,e){if(e)this.sections[e]&&this.sections[e].severity(t);else for(var i=Object.keys(this.sections),s=0,a=i.length;a>s;s++)this.sections[i[s]].severity(t)},a.prototype.dispose=function(){for(var t=Object.keys(this.sections),e=0,i=t.length;i>e;e++){var s=t[e],a=this._sectionElems[e];a.parentNode.style.display="",this.sections[s].dispose(),this._container.dataset.active=""}this.tileContainer.remove()};var n={inst:{}};window.IB.sd[t]=n;var r=function(){for(var t=document.querySelectorAll('ul[role="tiles"]'),e=0,i=t.length;i>e;e++){var s=t[e];if("1"!=s.dataset.active){s.dataset.active="1";var r=new a(s);r.id||(r.id="sd_"+Math.random().toString(32).substring(2)),n.inst[r.id]=r}}};n.bind=r,n.unbind=function(){for(var t=Object.values(n.inst),e=0,i=t.length;i>e;e++)t[e].dispose();n.inst={}},r()}();
