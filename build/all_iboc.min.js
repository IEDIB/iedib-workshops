...
!function(t){var e=function(t,e){if(e)for(var a=Object.keys(e),i=0,o=a.length;o>i;i++){var r=a[i],n=e[r];t.style[r]=n}},a=function(t,e){if(e)for(var a=e.split(" "),i=0,o=a.length;o>i;i++){var r=a[i].trim();r&&t.classList.add(r)}},i=function(t,i,o){var r=document.createElement(t);return a(r,i),o&&e(r,o),r},o=function(t){e(t,{position:"relative",opacity:"0.9"}),this.backdrop=i("div","pw-overlay-backdrop"),t.append(this.backdrop),this.overlay=i("div","pw-overlay-postit"),t.append(this.overlay)};o.prototype={back:function(t){t?this.backdrop.style.display="flex":this.backdrop.style.display="none"},msg:function(t){if(!t)return void(this.overlay.style.display="none");this.overlay.style.display="flex";var e=document.createElement("p");e.innerHTML=t,this.overlay.append(e),this.overlay.classList.add("pw-overlay-postit-appear")}},t.Overlay=o}(window);
