window.IB = window.IB || {}; window.IB.sd = window.IB.sd || {};  
         !function(){if(document.getElementById("sd_css_confetti.js")){return;}; var l = '.confetti-canvas {   position: absolute;   top:0;   left:0;   width:100%;   height:100%;  }'; var s = document.createElement('style'); s.type = 'text/css'; s.innerHTML = l; s.id="sd_css_confetti.js"; document.getElementsByTagName('head')[0].appendChild(s);}();
